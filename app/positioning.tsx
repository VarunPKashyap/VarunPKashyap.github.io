  ...
  return <section id="top" className="intro-section positioning-hero">
    ...
    <div className="opening-grid">
      <div className="opening-statement">
        ...
        <div className="opening-lower"><p className="opening-intro">I work in cultural insight and brand strategy. I use what I learn about people and place to decide what a brand should say, make or leave alone.</p><div className="opening-links"><a href="#work" className="opening-work-link">See the work<ArrowDown size={19}/></a><a href="#services" className="opening-services-link">What I can help with<ArrowUpRight size={17}/></a></div></div>
      </div>
    </div>
