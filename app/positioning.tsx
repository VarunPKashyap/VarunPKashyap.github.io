  ...
  return <section id="top" className="intro-section positioning-hero">
    ...
    <div className="opening-grid">
      <div className="opening-statement">
        ...
        <h1><span className="hero-title-line">Find the thought</span><span className="hero-title-line hero-title-accent">worth building on.</span></h1>
        <div className="opening-lower"><p className="opening-intro">I turn observations about how people live into clearer decisions for brands: positioning, briefs and editorial direction.</p><div className="opening-links"><a href="#work" className="opening-work-link">See selected work<ArrowDown size={19}/></a><a href="#services" className="opening-services-link">What I can help with<ArrowUpRight size={17}/></a></div></div>
      </div>
    </div>
    <HeroIndex/>
