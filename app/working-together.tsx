...
export function ServicesSection(){
 ...
 return <section id="services" className="services-section">
  ...
  <div className="services-heading"><h2>Working together.</h2><p>From a business question to a position, a brief or an editorial direction.</p></div>
