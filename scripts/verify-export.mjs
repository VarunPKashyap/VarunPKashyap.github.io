...
for(const text of ['Find the thought','Root decisions in cultural context.','From signal','A direction to test','Working together','Articulation is','Tab bankruptcy.'])assert.ok(html.includes(text),`Missing page content: ${text}`);
